...
# Mask thresholds (HSV)
mask_lower_threshold = np.array([0, 0, 0])
mask_upper_threshold = np.array([180, 255, 40])
...
def callback_receive_number_of_object_detected(msg):
    global number_of_detected_objects
    number_of_detected_objects = msg.count
    rospy.loginfo("Number of Object Detected: ")
    #print(number_of_detected_objects)
    #rospy.loginfo(msg.count)
...
class LaneFollower:
    ...
    def image_callback(self, image_msg):
        ...
        rospy.Subscriber("/darknet_ros/found_object", ObjectCount, callback_receive_number_of_object_detected)
        print(number_of_detected_objects)
        ...
        if number_of_detected_objects > 0.:
            v = 0.0
            omega = 0.0
            print('v = ', v)
            print('omega = ', omega)
